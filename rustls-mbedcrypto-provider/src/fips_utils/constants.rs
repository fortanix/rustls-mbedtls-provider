...
//! This module contains constants only used for `fips` checks
...
pub(super) fn get_known_ec_key(ec_group_id: &EcGroupId) -> Option<&'static (Arc<Mutex<Pk>>, usize)> {
...
pub(super) fn create_known_ec_key(ec_key_pem: &str) -> Pk {
